      ...
      <div className="relative bg-gray-900">
        <div className="absolute inset-0">
          <img
            ...
            src="https://images.unsplash.com/photo-1595425300377-c1eef204b2eb?auto=format&fit=crop&q=80&w=2000"
            alt="About Hero"
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96">
              <img
                src="https://images.unsplash.com/photo-1595425934374-2e83da8f27c8?auto=format&fit=crop&q=80&w=800"
                alt="Our History"
